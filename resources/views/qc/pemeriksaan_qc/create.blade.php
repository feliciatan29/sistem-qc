...
<div class="page-heading mb-4">
    <div class="page-heading-copy">
        ...
        <div>
            ...
            <h1 class="h3 mb-1">Tambah Pemeriksaan QC</h1>
            <p class="text-muted mb-0">Input data hasil pemeriksaan QC jaring baru.</p>
        </div>
    </div>
</div>
    ...
    <div class="col-12 col-xl-10">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-bold"><i class="bi bi-file-earmark-plus me-2 text-primary"></i> Form Tambah Data Pemeriksaan</h5>
            </div>
            
            <form action="{{ route('qc.pemeriksaan.store') }}" method="POST">
                @csrf
                <div class="card-body p-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="id_produksi" id="id_produksi" class="form-select @error('id_produksi') is-invalid @enderror" required>
                                ...
                                @foreach($produksi as $item)
                                    <option value="{{ $item->id }}" {{ old('id_produksi') == $item->id ? 'selected' : '' }}>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="jumlah_cek" id="jumlah_cek" class="form-control @error('jumlah_cek') is-invalid @enderror" value="{{ old('jumlah_cek', 0) }}" required min="0">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="baik" id="baik" class="form-control @error('baik') is-invalid @enderror defect-input" value="{{ old('baik', 0) }}" required min="0">
                            @error('baik')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <input type="number" name="rps" id="rps" class="form-control defect-input" value="{{ old('rps', 0) }}" required min="0">
                        </div>
                        <div class="col-md-3 col-sm-6">
                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            <input type="number" name="berbulu" id="berbulu" class="form-control defect-input" value="{{ old('berbulu', 0) }}" required min="0">
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <label class="form-label fw-semibold">Rusak Blok</label>
                            <input type="number" name="rusak_blok" id="rusak_blok" class="form-control defect-input" value="{{ old('rusak_blok', 0) }}" required min="0">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="keterangan" class="form-control" rows="3" placeholder="Tambahkan catatan jika diperlukan...">{{ old('keterangan') }}</textarea>
                    </div>
                </div>
